...
class Nominee extends CI_Controller {
    ...
    {   
        ...
        $data['title'] = 'Family member archive';         
      //print_r($data);
    ...
    {           
       ...
       // print_r($data['nominees']);
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/menu');
        $this->load->view('nominee/nominee_by_personid', $data);        
        $this->load->view('templates/footer');       
    ...
    public function create($id = NULL)
    {
       ...
       // echo $id;
        ...
        $data['title'] = 'Family information entry';
       ...
       // $this->form_validation->set_rules('contact_no', 'Contact no', 'required');        
        ...
        {   
          ...
          //  move_uploaded_file($tmp_nmc,'upload/non_marriage_certificate/'.$nmc_file_name);
            $nominee_id=$this->nominee_model->set_nominee($id=0,$image_name);          
           // this->nominee_model->set_nominee_basic($nominee_id,$data['employees_pension_info']);
            $this->session->set_flashdata('confirmation',"Family information added Successfully");    
            $nominee_id = base64_encode($nominee_id);
          
            
            redirect('nominee/view/'.$nominee_id);
