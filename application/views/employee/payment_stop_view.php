...
<?php echo form_open_multipart('employee/stop_payment_status/'.$id); ?>
    <div style="background: #ccffcc;padding:5px; ">


        
        <div  >
            <div class="rowlabel">Effective Date <span class="errMsg"><?php echo form_error('effective_date_of_stop_payment'); ?></span></div>
        <div>
            <input type="text" id="effective_date_of_stop_payment" name="effective_date_of_stop_payment" required <?php echo form_input('effective_date_of_stop_payment', set_value('effective_date_of_stop_payment')); ?></p>
        </div>
        </div>
        ...
        <button type="submit" id="btnUpdateStopPaymentsubmit" name="submit" value="ADD" >Stop Payment</button> 
        </div>
</div>
</div>
