 ...
 ?>
        <ul  class="nav navbar-nav" >
                ...
                <?php if (in_array("equipment", $page_list))  {?> 
                            <li class="dropdown "><a class="dropdown-toggle" id="dropEmp" role="button"  data-toggle="dropdown"><span class="glyphicon glyphicon-th-large"></span> Purchase / Expenses<b class="caret"></b></a>
                                    ...
                                    <li     role="presentation"><a role="menuitem" href="<?php echo site_url('expense/approval') ?>"><span class="glyphicon glyphicon-plus"></span> Approve expense</a></li> 
                                            ...
                                            <li     role="presentation"><a role="menuitem" href="<?php echo site_url('equipment/index') ?>"><span class="glyphicon glyphicon-list"></span> All equipment purchase</a></li>
                                            <li     role="presentation"><a role="menuitem" href="<?php echo site_url('equipment/create') ?>"><span class="glyphicon glyphicon-plus"></span> Add equipments / materials purchase</a></li>
                ...
                <?php if (in_array("fundtransfer", $page_list))  {?> 
                            ...
                            <li class="dropdown "><a class="dropdown-toggle" id="dropEmp" role="button"  data-toggle="dropdown"><span class="glyphicon glyphicon-th-large"></span> Fund transfer<b class="caret"></b></a>
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropEmp">   
                                    <li role="presentation"><a role="menuitem" href="<?php echo site_url('FundTransfer/currentbalance') ?>"><span class="glyphicon glyphicon-list"></span> Current balance</a></li>
                                    <li role="presentation"><a role="menuitem" href="<?php echo site_url('FundTransfer/read') ?>"><span class="glyphicon glyphicon-list"></span> Fund transfer history</a></li>
                                    <li role="presentation"><a role="menuitem" href="<?php echo site_url('FundTransfer/create') ?>"><span class="glyphicon glyphicon-list"></span> Fund transfer</a></li>
                                </ul>
                            </li>
